  ...
  return (
    ...
    >
      <div className={`section container ${classes.grid}`}>
        ...
        <div className={classes.list}>
          <Link href="https://github.com/BlueKrait7/">GitHub</Link>
          <Link href="https://gitter.im/BlueKrait7/">Gitter</Link>
          <Link href="https://twitter.com/The_Algorithms">Twitter</Link>
          <Link href="https://github.com/BlueKrait7/website">
            {t("sourceCodeFooter")}
          </Link>
        ...
        <a
          ...
          href="https://vercel.com?utm_source=BlueKrait7&utm_campaign=oss"
        >
