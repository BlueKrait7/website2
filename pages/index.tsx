                ...
                <div>
                  ...
                  <div className="MuiTypography-root MuiTypography-body1">
                    <Translation
                      name="contribute"
                      links={[
                        "https://hosted.weblate.org/engage/BlueKrait7/?utm_source=widget",
                      ]}
                    />
                  </div>
                  <div>
                    <Button
                      ...
                      href="https://github.com/BlueKrait7/"
                      target="_blank"
                      rel="noreferrer"
                    >
                    ...
                    <Button
                      ...
                      href="https://hosted.weblate.org/engage/BlueKrait7/?utm_source=widget"
                      target="_blank"
                      rel="noreferrer"
                    >
                    ...
                    <Button
                      ...
                      href="https://liberapay.com/BlueKrait7/donate"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
        ...
        <Section className={classes.social}>
          ...
          C480.224,136.96,497.728,118.496,512,97.248z"
            ...
            <Tooltip title={t("socialGitter")}>
              <Card>
                <IconButton
                  href="https://gitter.im/BlueKrait7/"
                  target="_blank"
                  rel="noreferrer"
